...
export const DATA_ENGINEERING_LEGACY_MAP = {
  ...
  "lakehouse-design": "storage-lakehouse",
  ...
  "feature-store-ml-data": "feature-store-experimentation",
  "serving-layer": "warehouse-serving",
...
export const DATA_ENGINEERING_TABS: DataEngineeringTab[] = [
  ...
  },
  {
    ...
    mins: 7,
    accent: "#38bdf8",
    summary: "Map every signal source before talking about Kafka or tables.",
    description: "Visualize playback, browse, search, QoE, billing, experiment, and CDC producers along with their first downstream consumers.",
  },
  {
    id: "architecture",
    label: "Architecture",
  ...
  },
  {
    ...
    mins: 9,
    accent: "#f59e0b",
    summary: "Connect sources, topics, keys, retention, schemas, and fan-out clearly.",
    description: "Cover ingestion lanes, topic design, partitioning, schema validation, DLQ, replay windows, and first-stage consumers.",
  },
  {
  ...
  },
  {
    ...
    mins: 8,
    accent: "#fbbf24",
    summary: "Show how Netflix publishes trusted daily truth and training datasets.",
    description: "Use DAG visuals, readiness checks, Spark/dbt transforms, DQ gates, and publish flows for official analytics outputs.",
  },
  {
    ...
    mins: 8,
    accent: "#8b5cf6",
    summary: "Make Bronze, Silver, and Gold feel like a living operating model.",
    description: "Show S3 layout, Iceberg responsibilities, replayability, compaction, schema evolution, and freshness by layer.",
  },
  {
    id: "data-modeling",
    label: "Data Modeling",
  ...
  {
    id: "warehouse-serving",
    label: "Warehouse / Serving",
    group: "MODELING",
    mins: 7,
    accent: "#fbbf24",
    summary: "Match dashboards, ad hoc SQL, and ops consumers to the right serving layers.",
    description: "Use a workload-to-store matrix for BI, Pinot, Trino, raw truth, and operational query expectations.",
  },
  {
    id: "feature-store-experimentation",
    label: "Feature Store / Experimentation",
    group: "PRODUCTION",
    mins: 8,
    accent: "#a855f7",
    summary: "Show how DE supports online features, offline training, and experiments.",
    description: "Separate online and offline feature paths, point-in-time correctness, entity keys, and experimentation support.",
  },
  {
  ...
  },
  {
    ...
    mins: 8,
    accent: "#ef4444",
    summary: "Show how Netflix corrects truth safely after late data, bugs, or bad releases.",
    description: "Cover watermarks, quarantine, DLQ, replay topics, batch correction, audit tables, and controlled backfill workflows.",
  },
  {
    id: "capacity-cost",
    label: "Capacity / Cost",
    ...
    description: "Derive event rates, partitions, retention, storage, compute costs, and map the stack to AWS plus open-source services.",
  },
  {
    id: "failures",
    label: "Failures",
  ...
  },
  {
    ...
    mins: 9,
    accent: "#38bdf8",
    summary: "Practice follow-ups, mock prompts, and recall inside one interview workout tab.",
    description: "Use question banks, flashcard-style prompts, and the guided mock interview to rehearse the full senior DE answer.",
  },
  {
    id: "cheat-sheet",
    label: "Cheat Sheet",
